        ...
        *::-webkit-scrollbar-thumb:hover {{
        ...
        @media (min-width: 1200px) {{
          .st-key-cgi_chat_dock {{
              ...
              bottom: 18px;
              left: calc(
                    var(--cgi-leftpanel-width) + var(--cgi-gutter) +
                    ((100vw - var(--cgi-leftpanel-width) - var(--cgi-gutter)) / 2)
                    );
              transform: translateX(-50%);
              right: auto !important;
               /* slightly wider complete prompt box */
              width: min(1500px, calc(100vw - var(--cgi-leftpanel-width) - var(--cgi-gutter) - 0.5rem)) !important;
              max-width: none !important;

              /*wider*/
              width: min(1280px, calc(100vw - var(--cgi-leftpanel-width) - var(--cgi-gutter) - 2rem)) !important;
              max-width: none !important;
              z-index: 25;
          }}
        }}
